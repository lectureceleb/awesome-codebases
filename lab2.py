...
weapons = ["Fist", "Knife", "Club", "Gun", "Bomb", "Nuclear bomb"]  # Available weapons
combatStrength = 0
...
input("Roll the dice to determine what weapon you will have (Press enter)")
weaponRoll = random.choice(diceOptions) - 1
combatStrength += weaponRoll
print("Your weapon: " + weapons[weaponRoll])
if weaponRoll <= 2:
...
print("Your " + weapons[weaponRoll] + " (" + str(combatStrength) + ") ---> Monster (" + str(mHealthPoints) + ")")
